...
```logsql
_time:24h app_name:in("qbittorrent.qbittorrent-sorter", "qbittorrent.qbittorrent-tqm", "qbittorrent.qbittorrent-watcher", "qbittorrent.qbittorrent-irc-watch") | unpack_json fields (level, event, component)
```
